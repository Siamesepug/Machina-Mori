...
var damage = EnemyStats.cube_child_damage
var damage_cd = EnemyStats.cube_damage_cd

var current_health = EnemyStats.cube_child_max_health

var charge_chance = EnemyStats.cube_charge_chance
var fire_chance = EnemyStats.cube_fire_chance

var max_xp_drops = EnemyStats.cube_max_xp_drops
...
func take_damage(damage):
	# bonus damage
	if current_health == EnemyStats.cube_max_health:
...
func is_dead():
	if current_health <= 0 && !dead:
		...
		max_xp_drops = EnemyStats.cube_max_xp_drops
