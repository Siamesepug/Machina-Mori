...
var speed = EnemyStats.wireball_speed
var damage = EnemyStats.wireball_damage
var damage_cd = EnemyStats.wireball_damage_cd

var current_health = EnemyStats.wireball_max_health

var charge_chance = EnemyStats.wireball_charge_chance
var fire_chance = EnemyStats.wireball_fire_chance

var max_xp_drops = EnemyStats.wireball_max_xp_drops
...
func take_damage(damage):
	# bonus damage
	if current_health == EnemyStats.wireball_max_health:
...
func is_dead():
	if current_health <= 0 && !dead:
		...
		max_xp_drops = EnemyStats.wireball_max_xp_drops
