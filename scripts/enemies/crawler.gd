...
var speed = EnemyStats.crawler_speed
var damage = EnemyStats.crawler_damage
var damage_cd = EnemyStats.crawler_damage_cd

var current_health = EnemyStats.crawler_max_health

var charge_chance = EnemyStats.crawler_charge_chance
var fire_chance = EnemyStats.crawler_fire_chance

var max_xp_drops = EnemyStats.crawler_max_xp_drops
...
func is_dead():
	if current_health <= 0:
		...
		max_xp_drops = EnemyStats.crawler_max_xp_drops
